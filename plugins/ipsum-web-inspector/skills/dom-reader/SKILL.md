...
- **selector** (optional): CSS selector to extract a specific element. If omitted, return the entire page HTML.
...
- With selector: `element.outerHTML` of the matched element
